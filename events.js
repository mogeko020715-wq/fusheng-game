...
const EVENTS = [
  {
    ...
    choices: [
      { t: '省下早饭钱给它买火腿肠', cond: (s) => s.money >= 1, ok: { money: -1, 心情: 10, 魅力: 1, mem: '你喂过一只秃尾巴的流浪猫，它蹭了蹭你的裤脚。' }, failTxt: '你摸摸口袋，空空如也。只能抱歉地摸摸它的脑袋。' },
      { t: '蹲下来摸摸它的头', ok: { 心情: 6, 魅力: 0.6 } },
      { t: '绕开走', ok: { 心情: -3 }, okTxt: '你走了，身后还有细细的叫声。你感到有点不是滋味。' },
    ],
  },
  {
    ...
    choices: [
      { t: '上前把他们拉开（魅力检定）', check: { attr: '魅力', dc: 60 }, ok: { 魅力: 2, 心情: 8, mem: '你劝开了胡同里最凶的一场架，此后好几年，街坊邻居里都传说你这孩子不一般。' }, fail: { 健康: -4, 心情: -5 }, failTxt: '混斗中你挨了一肘子，那俩小孩异口同声地叫你「少管闲事」。' },
  ...
  },
  {
    ...
    choices: [
      ...
      { t: '偷看同桌的', check: { attr: '魅力', dc: 70 }, ok: { 智力: 1, 心情: 3 }, fail: { 心情: -10, mem: '正好被老师抓到了，罚站了一下午。' } },
      { t: '听天由命，乱写一气', ok: { 心情: 2, 娱乐: 4 } },
    ],
  },
  {
    id: 'money', maxLife: 2, title: '地上的十块钱', min: 4, max: 15,
    text: '平日里人来人往的路口，一张十块钱静静躺在地上，像在对谁使眼色。',
    choices: [
      { t: '捡起来交给警察叔叔', ok: { 心情: 6, 魅力: 1.5, mem: '你把捡到的钱交给了警察叔叔，得到了一面小红旗。' } },
      { t: '四下无人，装进口袋', ok: { money: 10, 心情: 2 }, okTxt: '你装作吹口哨的样子，感觉心跳得有点快。' },
      { t: '踢到一边，不看不碰', ok: { 心情: 1 } },
    ],
  },
  {
    ...
    choices: [
      { t: '大方地打招呼、端茶倒水（魅力检定）', check: { attr: '魅力', dc: 55 }, ok: { 魅力: 2, 心情: 6, mem: '亲戚们夸你「这孩子真懂事」，你悄悄挺直了腰。' }, fail: { 心情: -3 }, failTxt: '你紧张得打翻了茶杯，脸红到了耳根。' },
      { t: '躲回自己房间', ok: { 心情: 2, 娱乐: 4 }, okTxt: '你钻进房间，世界安静了。' },
    ],
  },
  {
    ...
    choices: [
      { t: '咬着牙忍住（体质检定）', check: { attr: '体质', dc: 50 }, ok: { 体质: 2, 心情: 5, mem: '打针你没哭，护士阿姨奖励了你一颗糖。' }, fail: { 心情: -6 }, failTxt: '针还没扎你就哭了，哭完整张脸黏呼呼的都是鼻涕。' },
  ...
  },
  {
    ...
    choices: [
      { t: '往琴盒里放两块钱', cond: (s) => s.money >= 2, ok: { money: -2, 心情: 10, 魅力: 0.8, mem: '你给流浪歌手投了两块钱，他冲你笑着点头，眨了眨眼。' } },
  ...
  },
  {
    ...
    choices: [
      { t: '练家子，直接放倒（武术傍身）', cond: (s) => (s.skills.武术 || { lvl: 0 }).lvl >= 3, ok: { 体质: 2, 魅力: 2, 心情: 10, mem: '练过的身手派上了用场。从那以后，巷口没有再试图拦你的家伙。' }, okTxt: '三下五除二，对面落荒而逃。你拍拍手上的灰，像做了件小事。' },
      ...
      { t: '认栽给钱', cond: (s) => s.money >= 5, ok: { money: -5, 心情: -8 }, okTxt: '钱没了，和平时不一样，你绕了段很远的路才回家。' },
    ],
  },
  {
    ...
    choices: [
      { t: '搬个小板凳乖乖听', ok: { 心情: 10, 智力: 0.6, mem: '每逢夏夜，你都会回味起那个故事。' } },
  ...
  },
  {
    ...
    choices: [
      { t: '在屋檐下躲雨，看雨发呆', ok: { 心情: 6, 娱乐: 4, mem: '一场骤雨把你困在屋檐下，但你第一次发现雨声这么好听。' } },
  ...
  },
  {
    ...
    choices: [
      { t: '精心准备小礼物去赴约', cond: (s) => s.money >= 3, ok: { money: -3, 魅力: 2, 心情: 12, mem: '那场生日会，你们在草坪上放着风筝，跑来跑去，笑到肚子痛。' } },
      { t: '找借口推掉', ok: { 心情: -5 }, okTxt: '你说那天没空。挂电话时心里有点空落落的。' },
    ],
  },
  {
    ...
    choices: [
      { t: '指出他插队（魅力检定）', check: { attr: '魅力', dc: 62 }, ok: { 魅力: 2.5, 心情: 8, mem: '你当众指出了插队的人，队伍里有大娘附和：「连小孩都知道要讲文明，不好插队！」，大汉听罢挠着头走了。' }, fail: { 心情: -7 }, failTxt: '大汉瞪了你一眼：「小屁孩少管闲事。」你退缩了。' },
      { t: '随大流，沉默', ok: { 心情: -3 }, okTxt: '你低下了头。队伍很长，似乎没有人注意到这个插曲。' },
    ],
  },
  {
    ...
    choices: [
      { t: '抱回家养着（体质检定：能不能养活）', check: { attr: '体质', dc: 48 }, ok: { 心情: 10, mem: '你救活了一只翅膀受伤的小鸟，它好全那天，你在窗台看了它一宿。' }, fail: { 心情: -12, mem: '小鸟状态太差，没能撑过那个星期。你心里发苦，第一次意识到有些东西留不住。' } },
  ...
  },
  {
    ...
    cond: (s) => s.needs.健康 < 75,
    text: '半夜里你烧得满脸通红，浑身像被火烤着，脑袋沉得抬不起来。',
    choices: [
      { t: '喊醒爸妈带你去医院', ok: { 健康: 25, 心情: 5, mem: '那次高烧，爸妈轮流背着你跑到医院急诊。趴在背上，你心里感到一阵安稳。' } },
      { t: '咬牙硬扛（体质检定）', check: { attr: '体质', dc: 66 }, ok: { 体质: 2, 健康: 8, mem: '你硬扛过了一夜高烧，醒来时天光大亮，你觉得一下子神清气爽。' }, fail: { 健康: -18, buff: { name: '感冒', desc: '高烧未退，整个人好像飘在半空似的。', slots: 10, energyMul: 1.6 } }, failTxt: '烧得更厉害了，天旋地转。' },
    ],
  },
  {
    id: 'race', title: '运动会', min: 7, max: 14,
    cond: (s) => s.flags.wentSchool,
    text: '学校运动会。八百米报名的名单上还缺一个名字，体育委员的目光扫过全班。',
    choices: [
      { t: '报名！武术功底，稳赢', cond: (s) => (s.skills.武术 || { lvl: 0 }).lvl >= 3, ok: { 体质: 2.5, 魅力: 2.5, 心情: 12, mem: '运动会上你一路领先冲过终点，让全场都看呆了。' }, okTxt: '你赢得轻轻松松，冲线时还有空朝看台挥了挥手。' },
  ...
  },
  {
    ...
    cond: (s) => s.flags.wentSchool,
    text: '下课时，班里有个同学默默站到你桌前：「那个……能借你的笔记看看吗？」',
    choices: [
      { t: '大方地借，还附上讲解（魅力检定）', check: { attr: '魅力', dc: 55 }, ok: { 魅力: 2.5, 心情: 12, mem: '你把笔记借给了那个人。后来你们成了很好的朋友。' }, fail: { 心情: 3 }, okTxt: '对方道了谢。你心跳快了一节。' },
      { t: '借，但一句话也不敢多说', ok: { 心情: 4, 智力: 0.5 } },
    ],
  },
  {
    id: 'shoes', maxLife: 2, title: '崭新的球鞋', min: 7, max: 13,
    text: '班里某个同学换上了双崭新的名牌球鞋，身边围着一众好奇的同学。你低头看了看自己开胶的鞋。',
    choices: [
      { t: '并不在意，鞋合脚就行', ok: { 心情: 5, 智力: 0.5 }, okTxt: '你忽然觉得，开胶的鞋也能跑得很快。' },
      { t: '回家缠着妈妈要买（家境影响结果）', cond: (s) => true, ok: { 心情: -4 }, okTxt: () => S.familyKey === 'rich' ? '妈妈大手一挥，第二天你就穿上了新鞋，同学来向你搭话，却没想象中那么开心。' : '她面露难色。你话说到一半，咽了回去。你突然意识到什么，自那后你懂事了很多。' },
    ],
  },
  {
  ...
  },
  {
    ...
    cond: (s) => s.location === 'home' && !s.skills.烹饪, // 「第一道菜」只属于没碰过锅的人
    text: '厨房里热气腾腾。大人忙着做饭，见你在旁边张望，笑道：「想学学？来，搭把手。」',
    choices: [
      { t: '系上小围裙认真学', ok: { skill: { name: '烹饪', xp: 6 }, 心情: 6, mem: '你在灶台边学会了做第一道菜，番茄炒蛋。' } },
  ...
  },
  {
    ...
    choices: [
      ...
      { t: '转身离开', ok: { 心情: 1 }, okTxt: '你总觉得有什么不对劲。后来在学校听说好几个同学上了当。' },
    ],
  },
  {
    id: 'stargaze', title: '夏夜的星空', min: 4, max: 18, weight: 0.5, cg: 'cg-stargaze',
    cond: (s) => s.slot === 5,
    text: '停电了。整栋楼安安静静，你搬着小板凳坐到院子里，抬头看见了满天星星——多得数不清。',
    choices: [
      { t: '躺着看一晚上', ok: { 心情: 12, 智力: 0.8, mem: '停电的夏夜，你数着星星，不知不觉睡着了。' } },
      { t: '回屋睡觉', ok: { 精力: 8 } },
    ],
  },
  {
  ...
  },
  {
    ...
    text: '家里请来新的家庭教师，戴着金丝眼镜：「小朋友，今天我们学点有意思的。」',
    choices: [
  ...
  },
  {
    ...
    choices: [
      { t: '积极报名，认真表演节目（魅力检定）', check: { attr: '魅力', dc: 55 }, ok: { 魅力: 2.5, 心情: 10, mem: '敬老院里，一位奶奶挽着你不肯松手，说她孙子也这么大。' }, fail: { 心情: 2 }, okTxt: '你的节目演砸了，但老人们却笑得很开心，你跟着也笑了。' },
      { t: '躲一躲不报名', ok: { 心情: -2 } },
    ],
  },
  /* ---- 技艺开花：练出来的本事，会自己长出故事 ---- */
  {
    ...
    choices: [
      { t: '去！（智力检定）', check: { attr: '智力', dc: 62 }, ok: { 智力: 3, 心情: 10, skill: { name: '编程', xp: 5 }, mem: '你在奥赛选拔里拿了名次，升旗仪式上校长点名表扬了你。' }, fail: { 心情: -4, 智力: 0.5 }, failTxt: '题目难得离谱，出考场时你腿都坐麻了。但至少，你去过了。' },
  ...
  },
  {
    ...
    choices: [
      { t: '系上围裙，掌勺！', ok: { 心情: 14, 魅力: 1.5, skill: { name: '烹饪', xp: 4 }, mem: '那年的年夜饭是你做的。全家人吃得喷香，边吃边赞叹着你的手艺，你乐得喝了一大瓶可乐。' } },
  ...
  /* ---- 3-7岁 · 童年氛围包 ---- */
  {
    ...
    choices: [
      ...
      { t: '给猴子学猴子叫', ok: { 心情: 7, 娱乐: 4, mem: '你在爸爸肩膀上跟猴子「聊」了半天，谁也听不懂谁。' }, okTxt: '你「吱吱」地叫，猴子居然也冲你叫。妈妈笑了，爸爸的肩膀一耸一耸的。' },
    ],
  },
  {
    ...
    choices: [
      { t: '憋着笑，躲得更深一点', ok: { 心情: 8, mem: '你躲在门后听妈妈喊你的名字，笑得浑身发抖也不敢出声。' }, okTxt: '妈妈「找了好久」才发现门后的你。她装作大吃一惊的样子，你和爸爸对视，两人嘿嘿笑出了声。' },
  ...
  },
  {
    ...
    choices: [
      { t: '使劲踩自己的影子', ok: { 娱乐: 8, 心情: 6, mem: '你和自己的影子打了一架，谁也没赢。' }, okTxt: '你踩得气喘吁吁，影子还是那副得意的样子。算了，和解吧。' },
  ...
  },
  {
    ...
    choices: [
      ...
      { t: '看一会儿就把它放了', ok: { 心情: 6, 魅力: 0.5, mem: '你把爸爸抓的蝉放回了树上，它叫得比谁都响。' }, okTxt: '蝉从你手心飞走，「吱——」地一声钻进树叶里。爸爸说：「 蝉回家啦。」' },
    ],
  },
  {
    ...
    choices: [
      { t: '跟着姥姥扭，现学现卖', ok: { 心情: 9, 娱乐: 6, mem: '你跟着姥姥跳了一晚上广场舞，领舞的阿姨直夸你有天赋。' }, okTxt: '你学得七零八落，姥姥笑得前仰后合。回家的路上你一路都在哼那首歌。' },
      { t: '在旁边给姥姥拍手打节奏', ok: { 心情: 6, mem: '姥姥在队伍里跳得欢快，你在边上拍手拍得最响。' }, okTxt: '姥姥逢人就说：「这是我家孩子，专门来给我加油的。」' },
    ],
  },
  {
    ...
    choices: [
      ...
      { t: '偷偷抽走一张', ok: { 心情: 6, mem: '你从相册里悄悄抽走了一张百天照，藏进了枕头底下。' }, okTxt: '第二天照片又回到了相册里，还多了一张字条，是妈妈的字：「小坏蛋。」' },
    ],
  },
  {
    id: 'marbles', maxLife: 2, title: '玻璃珠', min: 4, max: 7,
    cond: (s) => s.location !== 'home',
    text: '几个小朋友蹲在花坛边晒自己的玻璃珠，奶白的、天蓝的、带猫眼的。你也掏出口袋里的存货加入分享——忽然，你在土缝里瞥见一抹从没见过的颜色。',
    choices: [
      { t: '挖出来！是颗稀有的琥珀色', ok: { 心情: 8, 魅力: 1, mem: '你挖到了一颗琥珀色的玻璃珠，成了圈子里公认的「收藏家」。' }, okTxt: '小伙伴们排着队想跟你换，你谁都没舍得给。' },
      { t: '喊大家一起来看', ok: { 心情: 6, 魅力: 2, mem: '你把稀有的玻璃珠让给了你们这最小的孩子，她高兴得欢呼雀跃，羊角辫一蹦一蹦的。' }, okTxt: '那颗珠子最后归了别人，但大家相比以往聚得更勤快了。' },
    ],
  },
  {
    ...
    choices: [
      ...
      { t: '把脸贴在姥爷背上小声哼', ok: { 心情: 6, mem: '姥爷的背很暖，你把歌声都哼进了他的外套里。' }, okTxt: '姥爷问：「唱啥呢？」你说：「秘密。」姥爷笑出了满脸褶子。' },
    ],
  },
  /* ---- 15-17岁 · 毕业季包 ---- */
  {
  ...
  {
    id: 'part-time', maxLife: 1, title: '第一次打工', min: 16, max: 17,
    text: '暑假，商业街的奶茶店在招临时工，时薪不高，但管一杯员工饮。你盯着招聘启事看了三遍。',
    choices: [
      { t: '去试试，挣自己的钱', ok: { money: 30, 体质: 1, 心情: 8, mem: '你第一次打工挣钱。第一天站了八个小时，回家腿都是抖的。' }, okTxt: '发工资那天你捏着那几张票子，觉得它们比压岁钱沉得多。' },
  ...
  },
  {
    ...
    cond: (s) => s.flags.wentSchool,
    text: '教学楼的走廊贴出了一面毕业留言墙，三天就写满了。有人写满了祝福，有人画了个巨丑的班主任，角落里还留着一小块空白。',
    choices: [
  ...
  {
    id: 'poor-finale-a', title: '家长会那天', min: 13, max: 16, weight: 5, cg: 'cg-poor-finale',
  ...
  {
    id: 'mid-finale-a', title: '爸爸的白头发', min: 14, max: 17, weight: 5, cg: 'cg-mid-finale',
  ...
  {
    id: 'bond-transfer-3a', title: '时间胶囊', min: 15, max: 17, weight: 5, cg: 'cg-bond-capsule',
  ...
  {
    id: 'bond-chess-3a', title: '最后一盘棋', min: 15, max: 17, weight: 5, cg: 'cg-bond-chess',
  ...
  },
  {
    ...
    text: (s) => {
      ...
      const lead = s.flags.crushA1
        ? '传了很久的纸条之后，你们已经很熟了，熟到全班都默认你们形影不离。'
        : '不知从什么时候起，你们总能在人群里一眼找到彼此的身影。';
      return `${lead}\n这天放学突降大雨，你没带伞，站在教学楼门口看雨帘发呆。一把伞忽然撑到你头顶——是${t}：「顺路，一起走吧。」`;
    },
    choices: [
      { t: '把伞往对方那边推了推，约好明天一起上学', ok: { 心情: 8, 魅力: 1.5, flag: { crushA2: true }, mem: '那个雨天，一把伞挤了两个人。从那天起，你们每天放学都「顺路」。' }, okTxt: '伞其实不大，你们各湿了半边肩膀，谁也没在意。\n那天你们一路都在聊班里的事，雨停了都没注意。' },
  ...
  {
    id: 'crush-3b', title: '留在夏天的遗憾', min: 16, max: 17, weight: 2,
    cond: (s) => !(s.flags.crushA1 && s.flags.crushA2) && !s.flags.crushDone && !s.flags['seen:crush-3b'],
    text: '拍毕业照那天，全班在台阶上挤作一团。你们站得很远，隔着好几排脑袋。\n快门响的前一秒，你忽然想：有些约定再不说出口，就要跟着这个夏天一起结束了。\n可快门还是响了。',
    choices: [
      { t: '挥挥手，把没说出口的约定留在这个夏天', ok: { 心情: -3, mem: '毕业照上你们隔得很远。有个约定，最终留在了那个夏天。' }, okTxt: '照片洗出来，你在人群里找了很久。\n原来青春里的大多数遗憾，都是没有下文的。' },
    ],
  },
  ...
  /* ---- 绘画 · 漫画 ---- */
  {
    ...
    choices: [
      ...
      { t: '坚决不认账', ok: { 心情: -4 }, okTxt: '班主任把漫画轻轻放回你桌上：「画得不错。就是下次，别把教案的事也画进去。」\n你恨不得钻进抽屉里。' },
    ],
  },
  {
  ...
  /* ---- 武术 · 散打 ---- */
  {
    ...
    choices: [
      { t: '扶着围绳站起来：「打。」', ok: { 体质: 2.5, 心情: 4, mem: '挨了第一记重拳，你扶着围绳站了起来。那天之后，师兄看你的眼神不一样了。' }, okTxt: '你站起来的时候，腿还在抖。\n但教练转身时说了句：「这孩子，能练出来。」' },
   ...
   * ============================================================ */
  {
    ...
    text: '毕业前，你画完了学生时代的最后一幅画。装裱那天，来看的人比想象的多——\n少年宫的老师说，要把这幅画留在走廊里，挂给后来的孩子们看。',
    choices: [
...
const MILESTONES = {
  3: {
    ...
    choices: [
      { t: '摇摇晃晃追着泡泡跑', ok: { 体质: 1, 心情: 8, mem: '你第一次逛公园，追了一下午泡泡。' } },
      { t: '紧紧牵着大人的手', ok: { 心情: 5 }, okTxt: '大人的手很大，很暖和。' },
    ],
  },
  4: {
    id: 'm4', title: '幼儿园开学',
    text: '背上新书包，你站在幼儿园门口。里面全是哭声，有的小孩紧紧抱着家长的腿不放。',
    choices: [
  ...
  7: {
    ...
    choices: [
      ...
      { t: '先交几个朋友要紧', ok: { 魅力: 2, mem: '上小学第一天，你先认识了一群好朋友。' } },
    ],
  },
  8: {
